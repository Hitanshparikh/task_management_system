...
<div class="container">
    ...
    <div class="form-group">
        ...
        <select name="time_frame" class="form-control">
            ...
            <option value="current_week" <?php echo ($time_frame === 'current_week') ? 'selected' : ''; ?>>Current Week</option>
            ...
            <option value="last_3_months" <?php echo ($time_frame === 'last_3_months') ? 'selected' : ''; ?>>Last 3 Months</option>
            <option value="last_6_months" <?php echo ($time_frame === 'last_6_months') ? 'selected' : ''; ?>>Last 6 Months</option>
            <option value="this_year" <?php echo ($time_frame === 'this_year') ? 'selected' : ''; ?>>This Year</option>
            <option value="last_year" <?php echo ($time_frame === 'last_year') ? 'selected' : ''; ?>>Last Year</option>
        </select>
    </div>
